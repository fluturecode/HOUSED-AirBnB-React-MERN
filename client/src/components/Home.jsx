...
const Home = () => {
    ...
    <div className="home">
        ...
        <div className="all-steps">  <h1> Step 3</h1>
            <h3> Search results designed specifically for you</h3>
            <p> Results that are exactly what you have in mind</p></div>
        <div className="all-steps">  <h1> Step 4</h1>
            <h3> Confirm and contact host</h3>
            <p> We will connect you and help you finish the process</p></div>
